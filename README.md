...
El análisis explora la relacion entre los ingresos (Variable dependiente) y la etnicidad (variable independiente), considerando controles para el modelo creado. Las variables utilizadas son las siguientes:

- **Ingresos (D524A1):**

  - Módulo: 5

  - Descripción: Ingreso total de la ocupación principal en Nuevos Soles

  - Leyenda:

    - Valor Numérico en soles
...
- **Etnicidad (P558C):**
  ...
  - Descripción: Por sus antepasados y de acuerdo a sus costumbres la persona se considera
  ...
  **Sexo (P207):**
  ...
  - Descripción: Sexo de la persona encuestada
...
- **Edad (P208A):**
  ...
  - Descripción: Edad de la persona en años cumplidos
...
- **Estrato (Estrato):**
  ...
  - Descripción: Estrato geográfico
...
- **Dominio (Dominio):**
  ...
  - Descripción: Dominio geográfico
